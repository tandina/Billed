            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" class="form-control blue-border" accept="image/png, image/jpg, image/jpeg" data-testid="file" />
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  ...
                  <input type="button" value="Annuler" id='btn-cancel' class="btn btn-annuler" onclick="history.back()">
                </div>
              </div>
            </div>
          </form>
